...
def setup(iris):
  AS5048BEncoder(name="phi_encoder", pid=62930, adr=64, invert=True, offset=3177, ring_size=16, i2c=FP(3548), datatype="rgb", debug=False, active=True, bcast=True, iris=iris)
  AS5048BEncoder(name="theta_encoder", pid=59289, adr=67, invert=True, offset=3076, ring_size=16, i2c=FP(3548), datatype="rgb", debug=False, active=True, bcast=True, iris=iris)
