...
def setup(iris):
  ...
  ESP32Core(name='ESP32Core', pid=6074, wifi=False, hbt_led=FP(55894), neo_status=FP(47403), function_button=FP(2276), bus=FP(6545), zorg=FP(21885), webserver=None, debug=False, active=True, bcast=False, iris=iris)
  FileSender(name='FileSender', pid=65001, debug=False, active=True, bcast=False, iris=iris)
  GRBLAxis(name='phi', pid=1410, move=None, max=150, min=-150, home=None, reset=FP(40190), debug=False, active=True, bcast=False, iris=iris)
  GRBLAxis(name='theta', pid=23147, move=None, max=150, min=-150, home=None, reset=FP(11168), debug=False, active=True, bcast=False, iris=iris)
  GRBLAxis(name='z', pid=16570, move=None, max=250, min=0, home=None, reset=FP(37697), debug=False, active=True, bcast=False, iris=iris)
  GRBLScara(name='grbl', pid=11895, webserver_output=False, theta_encoder=FP(6003), phi_encoder=FP(5054), UART=FP(30101), x=FP(23147), y=FP(1410), z=FP(16570), a=None, b=None, c=None, kinematics=FP(45799), debug=False, active=True, bcast=False, iris=iris)
